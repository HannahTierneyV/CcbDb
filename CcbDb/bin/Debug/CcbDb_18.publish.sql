...
CREATE TABLE [dbo].[EntityLicenses] (
    ...
    [CcbNumber] INT NOT NULL,
    CONSTRAINT [PK_EntityLicenses] PRIMARY KEY CLUSTERED ([UserId] ASC, [CcbNumber] ASC)
);
...
GO
PRINT N'Creating [dbo].[FK_EntityLicenses_CcbLicenses]...';


GO
ALTER TABLE [dbo].[EntityLicenses]
    ADD CONSTRAINT [FK_EntityLicenses_CcbLicenses] FOREIGN KEY ([CcbNumber]) REFERENCES [dbo].[CcbLicenses] ([CcbNumber]);
