...
GO
PRINT N'Creating [dbo].[EntityLicense]...';


GO
CREATE TABLE [dbo].[EntityLicense] (
    [EntityId]  INT IDENTITY (1, 1) NOT NULL,
    [CcbNumber] INT NOT NULL,
    CONSTRAINT [PK_EntityLicense] PRIMARY KEY CLUSTERED ([EntityId] ASC, [CcbNumber] ASC)
);
...
GO
PRINT N'Creating [dbo].[FK_EntityLicense_Entity]...';


GO
ALTER TABLE [dbo].[EntityLicense]
    ADD CONSTRAINT [FK_EntityLicense_Entity] FOREIGN KEY ([EntityId]) REFERENCES [dbo].[Entity] ([EntityId]);
...
IF NOT EXISTS (SELECT * FROM [Entity] WHERE [EntityId] IN (1, 2, 3))
BEGIN
...
IF NOT EXISTS (SELECT * FROM [License] WHERE [LicenseId] IN (1, 2, 3, 4)) AND
   NOT EXISTS (SELECT * FROM [License] WHERE [CcbNumber] IN (123456, 654321, 321654, 987654))
BEGIN
...
END
IF NOT EXISTS (SELECT * FROM [EntityLicense] WHERE [EntityId] IN (1, 2, 3))
BEGIN
	SET IDENTITY_INSERT [EntityLicense] ON;
	...
	SET IDENTITY_INSERT [EntityLicense] OFF;
END
GO
