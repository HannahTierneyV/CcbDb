...
CREATE TABLE [dbo].[EntityLicenses] (
    ...
    CONSTRAINT [PK_EntityLicenses] PRIMARY KEY CLUSTERED ([EntityId] ASC, [CcbNumber] ASC)
);
...
ALTER TABLE [dbo].[EntityLicenses]
    ADD CONSTRAINT [FK_EntityLicenses_Entities] FOREIGN KEY ([EntityId]) REFERENCES [dbo].[Entities] ([EntityId]);
