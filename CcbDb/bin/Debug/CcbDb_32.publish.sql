...
CREATE TABLE [dbo].[EntityLicenses] (
    ...
    CONSTRAINT [PK_EntityLicenses] PRIMARY KEY CLUSTERED ([EntityId] ASC, [CcbLicenseNumber] ASC)
);
...
IF NOT EXISTS (SELECT * FROM [Entities] WHERE [EntityId] IN (1, 2, 3))
BEGIN
...
IF NOT EXISTS (SELECT * FROM [Licenses] WHERE [LicenseId] IN (1, 2, 3, 4)) AND
   NOT EXISTS (SELECT * FROM [Licenses] WHERE [CcbNumber] IN (123456, 654321, 321654, 987654))
BEGIN
...
END
IF NOT EXISTS (SELECT * FROM [EntityLicenses] WHERE [EntityId] IN (1, 2, 3))
BEGIN
